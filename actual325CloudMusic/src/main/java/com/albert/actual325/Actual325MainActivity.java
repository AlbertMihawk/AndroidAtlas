...
import com.albert.actual325.model.MusicData;
import com.albert.actual325.service.MusicService;
import com.albert.actual325.ui.UIUtils;
import com.albert.actual325.util.FastBlurUtil;
import com.albert.actual325.util.StatusBarUtil;
import com.albert.actual325.util.ToolbarUtils;
import com.albert.actual325.view.DiscView;

import java.io.Serializable;
import java.util.ArrayList;
import java.util.List;

import static com.albert.actual325.view.DiscView.DURATION_NEEDLE_ANIMATOR;


/**
 * Filename : Actual325MainActivity.java
 *
 * @author : Mihawk
 * @since : 2019-07-13
 */

public class Actual325MainActivity extends AppCompatActivity implements DiscView.IPlayInfo, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_actual325_main);
    ...
    private void initView() {
        ...
        bg_switcher.setFactory(new ViewSwitcher.ViewFactory() {
            ...
            public View makeView() {
                ...
                imageView = new ImageView(Actual325MainActivity.this);//实例化一个ImageView类的对象
    ...
    private Drawable getForegroundDrawable(int musicPicRes) {
        ...
        final float widthHeightSize = (float) (UIUtils.getScreenWidth(Actual325MainActivity.this)
