...
public class MaterialDesign324Activity extends AppCompatActivity {
    //应用
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_material_design324);
        getSupportActionBar().hide();
        initView();

//        FrameLayout fl = findViewById(R.id.fl);
//        View view = LayoutInflater.from(this).inflate(R.layout.test_ll, fl, false);
...
//        }
////        getLayoutInflater().inflate(R.layout.test_btn, (LinearLayout) ((FrameLayout) view).findViewById(R.id.ll), true);
    ...
    private void initView() {
        ...
        DelegateAdapter.Adapter bannerAdapter = new BaseDelegateAdapter(this, new LinearLayoutHelper(),
        ...
        BaseDelegateAdapter marqueeAdapter = new BaseDelegateAdapter(this, new LinearLayoutHelper(),
        ...
        delegateAdapter.addAdapter(marqueeAdapter);
...
//    class BaseDelegateAdapter extends DelegateAdapter.Adapter<BaseViewHolder> {
//
